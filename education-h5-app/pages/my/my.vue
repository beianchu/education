...
export default {
	setup() {
		...
		const mymoney=()=>{
			uni.navigateTo({
				url: '/pages/blanceView/blanceView',
				success: res => {},
				fail: () => {},
				complete: () => {}
			});
		...
		const wes=()=>{
			uni.navigateTo({
				url: '/pages/OptionsvVeiw/OptionsvVeiw',
				success: res => {},
				fail: () => {},
				complete: () => {}
			});
