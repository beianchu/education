			...
			<view class="course-item" v-for="item in obj.courseList" :key="item.id" @click="toDetail(item)">
				...
				<view class="course-text">
					...
					<view class="teacther-text">
						<image src="../../static/static/images/no.png" mode=""></image> {{item.nickName}}
					</view>
					<view class="bottom">
						<view class="left">
							<image class="img1" src="../../static/static/images/no.png" mode=""></image>
							{{item.isFree==1?item.priceOriginal:'免费'}}
						</view>
						<view class="right">
							<image class="img2" src="../../static/static/images/no.png" mode=""></image>
							{{item.studyTotal}}人在学
						</view>
					</view>
				</view>
